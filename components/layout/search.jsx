...
const Search = () => {
  ...
  return (
    <>
      <h1 className="text-[52px] text-white text-center m-auto max-md:w-86 max-md:leading-18 max-lg:w-120 max-lg:leading-20 leading-30 font-bold flex flex-1 justify-center align-middle w-full my-4">
      ...
      <form
        ...
        className="flex items-center max-md:flex-col w-full max-w-164 max-lg:w-full max-lg:max-w-none text-white h-fit gap-4 justify-center "
      >
            ...
            (loading ? (
              ...
              <div className="p-2 absolute top-17 flex flex-col gap-2 w-full left-0 bg-surface h-fit rounded-lg">
                {found.length > 0 ? (
                  ...
                  <p className=" text-xl font-bold text-center py-10 ">
              ...
              <div className="p-2 absolute top-17 flex flex-col gap-2 w-full left-0 bg-surface h-fit rounded-lg">
                <p className=" text-xl font-bold text-center px-5 py-10 ">
                  There was an error completing your search. Please try again
                </p>
              </div>
            ))}
        </div>
